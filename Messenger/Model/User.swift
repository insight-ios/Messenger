...
struct User {
    ...
    init?(dict: [String: Any], documentID: String) {
        ...
        self.init(userID: documentID, nickname: nickname, statusMessage: statusMessage, profileImageURL: profileImage, profileBackgroundImageURL: profileBackgroundImage)
    }
